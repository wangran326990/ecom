package com.atguigu.gulimall.auto.controller;
...
import com.atguigu.gulimall.auto.feign.ThirdPartFeignService;
...
public class LoginController {
    ...
    public String login(UserLoginVo vo, RedirectAttributes attributes, HttpSession session){
        ...
        if (r.getCode() == 0) {
            ...
            return "redirect:http://auth.ran.me/login.html";
        }
    }
    ...
    public String register(@Valid UserRegisterVo registerVo, BindingResult result, RedirectAttributes attributes) {
        ...
        if (result.hasErrors()){
            ...
            //1.2 重定向到注册页
            return "redirect:http://auth.ran.me/reg.html";
        }else {
            //2.若JSR303校验通过
            //判断验证码是否正确
